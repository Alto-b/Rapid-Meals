...
$selqry="select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_item p on p.item_id=c.item_id where booking_status>1 and cart_status>0 and  user_id='".$_SESSION["uid"]."'";
