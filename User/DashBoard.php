    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="MyBooking.php">My orders</a></li>
          <li><a href="PackageView.php">Package</a></li>
          ...
          <li class="dropdown"><a href="#"><span>F&C</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
      ...
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          ...
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="SearchProduct.php" class="btn-book-a-table">Order food</a>
  ...
  <main id="main">
          ...
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              ...
              <ul>
                ...
                <li><i class="bi bi-check2-all"></i>Food gets prepared when you need </li>
              </ul>
              <p>
               .
              </p>
    ...
    <section id="menu" class="menu">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
        <h2>Our Menu</h2>
          <p>Check Our <span>Todays Specials</span></p>
        </div>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item" onclick="window.location='SearchProduct.php'">
                <img src="../Asset/Template/Main/assets/img/menu/biriyani.jpg" class="menu-img img-fluid" alt=""> 
              ...
              <div class="col-lg-4 menu-item" onclick="window.location='SearchProduct.php'">
                <img src="../Asset/Template/Main/assets/img/menu/burger.png" class="menu-img img-fluid" alt=""></a>
                <h4>Jumbo burger</h4>
                <p class="ingredients">
              ...
              <div class="col-lg-4 menu-item" onclick="window.location='SearchProduct.php'">
               <img src="../Asset/Template/Main/assets/img/menu/momos.png" class="menu-img img-fluid" alt=""></a>
                <h4>Steamed momos</h4>
                <p class="ingredients">
                Steamed veg. momos
                </p>
              ...
              <div class="col-lg-4 menu-item" onclick="window.location='SearchProduct.php'">
                <img src="../Asset/Template/Main/assets/img/menu/tika.png" class="menu-img img-fluid" alt=""></a>
                <h4>Aloo tikki</h4>
                <p class="ingredients">
              ...
              <div class="col-lg-4 menu-item" onclick="window.location='SearchProduct.php'">
                <img src="../Asset/Template/Main/assets/img/menu/shake.png" class="menu-img img-fluid" alt=""></a>
              ...
              <div class="col-lg-4 menu-item" onclick="window.location='SearchProduct.php'">
                <img src="../Asset/Template/Main/assets/img/menu/mutton.png" class="menu-img img-fluid" alt=""></a>
                <h>Mutton curry</h4>
                <p class="ingredients">
