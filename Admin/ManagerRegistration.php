...
$insQry="insert into tbl_manager(manager_name,manager_contact,manager_email,manager_address,manager_gender,place_id,district_id,manager_photo,manager_proof,manager_password)values('".$name."','".$contact."','".$email."','".$address."','".$gender."','".$district."','".$place."','".$photo."','".$proof."','".$password."')";
	...
	if($con->query($insQry))
		{
			...
			<script>
			alert("data inserted");
			window.location="ManagerRegistration.php";
			</script>
			<?php
		}
		else
  ...
  <table width="384" border="1" style="border-collapse:collapse">
    ...
    <tr>
      ...
      <td><label for="list_district"></label>
        <select name="list_district" id="list_district" onchange="getPlace(this.value)" required="">
    ...
    <tr>
      ...
      <td><label for="list_place"></label>
        <select name="list_place" id="txt_place" required="">
        <option>---select---</option>
      </select></td>
    </tr>
    <tr>
      ...
      <input type="file" name="file_photo" id="txt_photo" required=""  /></td>
    </tr>
      <tr>
      <td>PROOF</td>
      <td align="left"><label for="file_image"></label>
        <label for="txt_proof"></label>
      <input type="file" name="file_proof" id="txt_proof" required=""/></td>
    </tr>
    <tr>
      <td>PASSWORD</td>
